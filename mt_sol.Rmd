...
November 6, 2018
Note
Most of the errors on this midterm involved producing the wrong output for one or more of the questions; if you fall into this category, please compare your code to the model solutions to see where they differ.

Another point we want to emphasize is that your code must knit whenever we run it. Replicability is something we have emphasized often in this course. As previously noted in the Problem Set 4 and Problem Set 5 solutions, failure to knit is a 2 point penalty.

One way you may have gotten this error is by referencing a local file or directory rather than using a relative path which does not reference anything locally. See the Problem Set 5 solution and previous solutions that involve reading in files if you need a refresher on how this works. Also, if you reference a file that your script does not download, and fail to push that file, it will not knit for others, as noted in the Problem Set 4 solution. Another issue involves including View() commands in your .Rmd, which can prevent knitting on Macs.

We were impressed by your hard work on this midterm and look forward to seeing you apply the skills you learned on the final project!

Question 1
Intention of voting
DEM.	REP.	UND.
Already voted	35%	49%	15%
Almost certain	43%	46%	10%
Very likely	42%	30%	22%
Somewhat likely	29%	23%	31%
Not very likely	22%	16%	62%
Not at all likely	30%	15%	46%
Question 2
The total number of completed interviews was 48960.
...
Question 3
Change in Republican Advantage in Districts with Major Swings
...
write_rds(shiny_data, "mt_2_app/shiny_data.rds")
```
